...
public class ApacheHttpClientConfiguration {
    ...
    // Timeouts
    int CONNECTION_TIMEOUT = 10 * 1000; // We will wait for 10 seconds until a TCP connection is established or the TCP Handshake is completed
    int REQUEST_TIMEOUT    = 20 * 1000; // We will wait 20 seconds for getting a connection from the connection pool
    int SOCKET_TIMEOUT     = 10 * 1000; // We will wait 10 seconds, to receive the complete data from the external call
